...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'src.core.register',
        'src.core.registration_types',
        'src.core.registration_flows',
        'src.core.registration_flows.default_engine',
        'src.core.registration_flows.topic_1848126_engine',
        'src.core.registration_flows.topic_1840923_engine',
        'src.core.registration_flows.topic_1849054_engine',
